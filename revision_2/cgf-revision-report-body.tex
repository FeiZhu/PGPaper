...
We provide a supplemental video that compares four different $\delta$ values for a bending beam. It shows that the bending beam with $\delta$ values of $1.0\lambda$ and $1.5\lambda$ are visually undistinguished, which suggests that the simulation results are less sensitive to the parameter $\delta$.
...
\noindent{Q: }\emph{Unreasonable statements about the relationship between rotation artifacts, geometric linearity and stress-strain linearity.}
