...
Figure~\ref{fig:6_after} provides an example of controlling the dust with different $\alpha$ values.
...
\begin{tabular}{lccccccccccc}
  ...
  \hline
  Glass Wall[Figure~\ref{fig:1}(a)(b), Figure ~\ref{fig:6_after},~\ref{fig:14}]     & $3.0\times10^5$ & 1.45$\lambda$ & $5.0\times10^7$ & $3.3\times10^{7}$ & $2.0\times10^{7}$        & 2200 & $\infty $ & 0.0             & 0.0005   & $1.0\times10^{-6}$          & $\sim2.4$ \\
