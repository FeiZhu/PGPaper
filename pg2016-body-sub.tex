...
\teaser{
 \includegraphics[width=\linewidth]{eg_new.eps}
 \centering
...
\begin{figure}[t]
  \centering
  %\mbox{} \hfill
  \includegraphics[width=0.7\linewidth]{./figs/peridynamics_circle.eps}
  \caption{\label{fig:2}
...
\begin{figure}[h]
  \centering
  %\mbox{} \hfill
  \includegraphics[width=\linewidth]{./sampleFig.eps}
  \caption{\label{fig:5}
  2d view.
}
\end{figure}
