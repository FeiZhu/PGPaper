...
\emph{Please describe the vertex split strategy with a very short paragraph. 4 lines?}
...
\begin{tabular}{lccccccccccc}
  ...
  \hline
  Glass Wall[Figure~\ref{fig:1}(a)(b)]     & $3.0\times10^5$ & 1.45$\lambda$ & $5.0\times10^7$ & $3.3\times10^{7}$ & $2.0\times10^{7}$        & 2200 & $\infty $ & 0.0             & 0.0005   & $1.0\times10^{-6}$          & $\sim2.4$ \\
  ...
  Jello [Figure~\ref{fig:6}]               & $4.6\times10^5$ & 1.45$\lambda$ & $8.6\times10^7$ & $1.0\times10^3$   & $4.6\times10^2$          & 1000 & $\infty $ & 0.0             & 0.4      & $5.0\times10^{-5}$   & $\sim3.8$ \\
  Beam Stretch [Figure~\ref{fig:7}]        & $2.2\times10^4$ & 1.0 $\lambda$ & $1.3\times10^6$ & $2.0\times10^3$   & $(9.2,1.5,2.2)\times10^2$& 1000 & $\infty$  & 0.0             &$\infty$  & $1.0\times10^{-5}$ & $\sim0.2$ \\
