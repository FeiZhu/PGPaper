...
The dilation term $A_{dilation}$ measures the volume change without any shape distortion, which is defined as:
\begin{equation}
...
\label{eq:3}
\end{equation}
where $d$ and $a$ are both peridynamics material parameters.
