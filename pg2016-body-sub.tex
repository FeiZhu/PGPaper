...
\begin{figure}[t]
  \centering
  %\mbox{} \hfill
  \includegraphics[width=\linewidth]{./figs/demo_pull_armadillo_2.jpg}
  \caption{\label{fig:3}
...
\begin{figure*}[t]
  \centering
  %\mbox{} \hfill
  \includegraphics[width=\linewidth]{./figs/demo_tear_armadillo_7.jpg}
  \caption{\label{fig:5}
...
\begin{figure}[h]
  \centering
  %\mbox{} \hfill
  \includegraphics[width=\linewidth]{./figs/demo_tear_armadillo_close_view_2.jpg}
  \caption{\label{fig:6}
...
\begin{figure}[h]
  \centering
  %\mbox{} \hfill
  \includegraphics[width=\linewidth]{./figs/demo_jello.jpg}
  \caption{\label{fig:9}
  jello.
}
\end{figure}
